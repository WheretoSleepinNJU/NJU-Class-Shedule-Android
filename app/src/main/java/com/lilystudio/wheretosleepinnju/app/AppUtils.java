...
import com.lilystudio.wheretosleepinnju.data.greendao.DaoMaster;
import com.lilystudio.wheretosleepinnju.data.greendao.DaoSession;
import com.lilystudio.wheretosleepinnju.data.greendao.MyOpenHelper;
...
import com.lilystudio.wheretosleepinnju.widget.UpdateJobService;
...
public class AppUtils {
    ...
    public static void updateWidget(Context context) {
        ...
        intent.setComponent(new ComponentName("com.lilystudio.wheretosleepinnju", "com.lilystudio.wheretosleepinnju.widget.MyWidget"));
